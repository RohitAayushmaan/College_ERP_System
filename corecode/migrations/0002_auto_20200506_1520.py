# Generated by Django 3.0.5 on 2022-11-15 14:20
...
def default_site_config(apps, schema_editor):
    ...
    Config.objects.bulk_create([
        Config(key='school_name', value='KIET'),
        Config(key='school_slogan', value='Shaping Young Mind'),
        Config(key='school_address', value='Ghaziabad, India'),
    ])
